...
export const LITELLM_CLOUD_PROVIDER: CloudEmbeddingProvider = {
  ...
  icon: LiteLLMIcon,
  description: "Use any LLM API via LiteLLM proxy.",
  apiLink: "https://docs.litellm.ai",
  embedding_models: [],
};
...
export const AZURE_CLOUD_PROVIDER: CloudEmbeddingProvider = {
  ...
  icon: AzureIcon,
  description: "Use Azure OpenAI Service for embeddings.",
  apiLink: "https://learn.microsoft.com/en-us/azure/cognitive-services/openai/",
  embedding_models: [],
};
