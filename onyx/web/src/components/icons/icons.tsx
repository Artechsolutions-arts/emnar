...
export const EmnarLogoTypeIcon = ({
    size = 16,
    className = defaultTailwindCSS,
}: IconProps) => {
    return (
...
export const OnyxIcon = EmnarIcon;
export const OnyxLogoTypeIcon = EmnarLogoTypeIcon;
export const VirchowSidebarIcon = EmnarIcon;
export const VirchowMainIcon = EmnarLogoTypeIcon;
