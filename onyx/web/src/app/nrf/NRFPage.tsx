...
export default function NRFPage({ isSidePanel = false }: NRFPageProps) {
  const { setUseOnyxAsNewTab: setUseVirchowAsNewTab } = useNRFPreferences();
      ...
      {!isSidePanel && (
        <>
          <SettingsPanel
            ...
            handleUseOnyxToggle={handleUseVirchowToggle}
          />
          ...
          <Modal open={showTurnOffModal} onOpenChange={setShowTurnOffModal}>
            <Modal.Content width="sm">
              <Modal.Header
                ...
                title="Turn off Emnar new tab page?"
                description="You'll see your browser's default new tab page instead. You can turn it back on anytime in your Emnar settings."
      ...
      {!user && (
        <Modal open onOpenChange={() => {}}>
          <Modal.Content width="sm" height="sm">
            <Modal.Header icon={SvgUser} title="Welcome to Emnar" />
            <Modal.Body>
