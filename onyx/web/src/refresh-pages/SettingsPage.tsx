    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            title="Default Model"
            description="This model will be used by Emnar by default in your chats."
          >
            <LLMPopover
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            ...
            description="Let Emnar reference stored memories in chats."
          >
            <Switch
          ...
          <InputLayouts.Horizontal
            ...
            description="Let Emnar generate and update stored memories."
          >
            <Switch
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              ...
              lose access to Emnar. This action cannot be undone.
            </Text>
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              Emnar will no longer be able to access or search content from your{" "}
